...
{
    [Migration(114)]
    public class DBMIgrate_114 : DBMIgrateBase
    {

        public override void Up()
        {
            
            Alter.Table(WholeTableName("SystemHtml"))
                       .AddColumn("LastUpdateTime").AsDateTime( ).Nullable() 
                      ;
        ...
        <ul id=""nav"" style=""user-select: auto;"">
            ...
            <li class=""open"" style=""user-select: auto;"">
                ...
                <ul class=""sub-menu"" style=""display: block; user-select: auto;"">
                    ...
                    <li style=""user-select: auto;"">
                        <a onclick=""xadmin.add_tab('表单生成','/sd23nj/DBform/index')"" style=""user-select: auto;"">
                            <i class=""iconfont"" style=""user-select: auto;""></i>
                            <cite style=""user-select: auto;"">表单生成</cite>
                        </a>
                    </li>
                    <li style=""user-select: auto;"">
            ...
            Insert.IntoTable(WholeTableName("SystemHtml")).Row(SystemDictionary2);
